    ...
    <>
      ...
      <div className="lg:flex">
        <div className="lg:mr-8 mb-8 lg:mb-0">
          <p className="font-light text-gray-400 mb-8 lg:mb-0 lg:w-[400px] lg:min-w-[400px]">{isNuevaOpinion ? "Si has participado en alguno de mis cursos o hemos trabajado juntos en algun proyecto, me encantaria que me dejaras tu opinion para que otros puedan verla." : "Aqui van las opiniones de todos mis alumnos y personas que hayan participado en mis cursos de alguna manera o con las que haya trabajado en algun punto. <br /> <br />  De momento esta en construccion asi que por ahora las opiniones no van a tener validacion, pero la idea es que en un futuro cada opinion escrita este respaldada por algun perfil de linkedin, cuenta de google, nombre de empresa, etc."}</p>
